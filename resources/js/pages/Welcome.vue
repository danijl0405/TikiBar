...
<template>
    ...
    <main class="relative text-tiki-sand">
        ...
        <section class="relative flex min-h-screen items-center justify-center px-4 pt-24 pb-16 text-center">
            <div data-reveal data-idx="0" :class="revealClasses(0)" class="max-w-3xl">
        ...
        <section class="relative px-4 py-32 sm:py-40">
            <div class="mx-auto max-w-3xl">
                <div data-reveal data-idx="1" :class="revealClasses(1)" class="rounded-3xl bg-tiki-night/60 p-8 shadow-2xl backdrop-blur-md sm:p-12">
        ...
        <section class="relative px-4 py-32 sm:py-40">
            <div class="mx-auto grid max-w-5xl gap-10 sm:grid-cols-2 sm:items-center">
                <div data-reveal data-idx="2" :class="revealClasses(2)">
                ...
                <div
                    ...
                    class="rounded-3xl bg-tiki-sunset/15 p-8 shadow-2xl ring-1 ring-tiki-sunset/30 backdrop-blur-md"
                >
                    <p class="text-7xl">🔥</p>
                    <p class="mt-4 text-2xl font-semibold text-tiki-coral">6 espetos por hora</p>
        ...
        <section class="relative px-4 py-32 sm:py-40">
            <div class="mx-auto grid max-w-5xl gap-10 sm:grid-cols-2 sm:items-center">
                <div
                    ...
                    class="order-2 rounded-3xl bg-tiki-ocean/20 p-8 shadow-2xl ring-1 ring-tiki-ocean/30 backdrop-blur-md sm:order-1"
                >
                    <p class="text-7xl">🍹</p>
                    <p class="mt-4 text-2xl font-semibold text-tiki-coral">Mai Tai, Piña Colada, Mojito…</p>
                    <p class="mt-2 text-tiki-sand/80">
                        Y nuestro <strong>Tiki Bar Special</strong>: tres rones, frutas tropicales y
                        un secreto que solo conoce el camarero.
                    </p>
                </div>
                <div data-reveal data-idx="5" :class="revealClasses(5)" class="order-1 sm:order-2">
        ...
        <section class="relative px-4 py-32 sm:py-40">
            <div class="mx-auto max-w-3xl text-center">
                <div data-reveal data-idx="6" :class="revealClasses(6)">
        ...
        <section class="relative px-4 py-24">
            <div class="mx-auto max-w-6xl">
                <div data-reveal data-idx="7" :class="revealClasses(7)" class="flex flex-wrap items-end justify-between gap-2">
                    <div>
                ...
                <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <article
                        ...
                        class="rounded-2xl border border-white/10 bg-tiki-night/65 p-5 shadow-xl backdrop-blur-md"
                    >
        ...
        <section class="relative px-4 py-32">
            <div class="mx-auto grid max-w-5xl gap-6 sm:grid-cols-2">
                <div
                    ...
                    class="rounded-3xl border border-tiki-leaf/40 bg-tiki-leaf/15 p-8 shadow-xl backdrop-blur-md"
                >
                    <p class="text-5xl">📞</p>
                    <h3 class="mt-3 text-2xl font-bold">Pídenos por teléfono</h3>
                ...
                <div
                    ...
                    class="rounded-3xl border border-tiki-sunset/40 bg-tiki-sunset/15 p-8 shadow-xl backdrop-blur-md"
                >
                    <p class="text-5xl">🍽️</p>
                    <h3 class="mt-3 text-2xl font-bold">Reserva tu mesa</h3>
                    <p class="mt-2 text-tiki-sand/85">
